...
const Home = () => {
  ...
  return (
    <>
      <section className="relative lg:bg-home-bg-img lg:bg-no-repeat lg:bg-right-19vh lg:bg-60 lg:m-0 mb-10 flex flex-col-reverse mt-[10vh] lg:mt-0 lg:flex-row items-center justify-between h-max overflow-hidden">
